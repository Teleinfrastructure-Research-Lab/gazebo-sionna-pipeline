...
"""Batch wrapper that composes static and dynamic frame manifests via compose_frame_scene.py.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Batch-compose static + dynamic frame manifests using dynamic_rigid/compose_frame_scene.py."
    )
    parser.add_argument(
        "--config",
        type=Path,
