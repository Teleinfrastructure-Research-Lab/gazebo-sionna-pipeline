...
This stage consumes the actor metadata extracted by script 37 and the separate
...
DEFAULT_ACTOR_CONFIG = PROJECT_ROOT / "rt_out" / "config" / "actor_dynamic_config.json"
DEFAULT_DYNAMIC_CONFIG = PROJECT_ROOT / "rt_out" / "config" / "dynamic_prototype_config.json"
DEFAULT_RT_MATERIAL_CONFIG = PROJECT_ROOT / "rt_out" / "config" / "rt_material_mapping.json"
DEFAULT_OUTPUT = PROJECT_ROOT / "rt_out" / "dynamic_frames" / "actor_frame_samples.json"
