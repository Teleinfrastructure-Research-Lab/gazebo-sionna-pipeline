...
EXPORT_SCRIPT = SCRIPT_32_EXPORT_DYNAMIC_FRAME_MESHES
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Batch-export dynamic meshes for an experiment using dynamic_rigid/32_export_dynamic_frame_meshes.py."
    )
    parser.add_argument(
        "--config",
        type=Path,
