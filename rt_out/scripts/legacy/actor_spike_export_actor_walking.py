...
from runtime_config import PROJECT_ROOT, RuntimeConfigError, find_blender as shared_find_blender  # noqa: E402
...
def find_blender() -> Path:
    # This feasibility spike stays isolated from the validated pipeline, but it
    # should still reuse the shared Blender lookup logic.
    try:
        return shared_find_blender()
