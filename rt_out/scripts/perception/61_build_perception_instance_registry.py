...
DEFAULT_STATIC_MANIFEST = Path("rt_out/manifests/static_manifest.json")
DEFAULT_STATIC_REGISTRY = Path("rt_out/manifests/static_registry.json")
DEFAULT_ACTOR_MANIFEST = Path("rt_out/manifests/actor_manifest.json")
...
def resolve_paths(config_path: Path, args: argparse.Namespace, config: dict[str, Any]) -> dict[str, Path]:
    ...
    return {
        ...
        "semantic_label_map": args.semantic_label_map or (output_root / "configs" / "semantic_label_map.json"),
