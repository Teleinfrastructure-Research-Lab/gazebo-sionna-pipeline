...
def parse_args() -> argparse.Namespace:
    default_config = Path("rt_out/experiments/perception_rt_small_v0/configs/perception_dataset_config.json")
...
def main() -> None:
    ...
    try:
        ...
        semantic_label_map_path = experiment_root / "configs" / "semantic_label_map.json"
