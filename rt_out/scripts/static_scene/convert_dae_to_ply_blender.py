...
def main():
    ...
    if "--help" in argv or "-h" in argv:
        print("Usage: blender --background --python convert_dae_to_ply_blender.py -- input.dae output.ply")
        return
    if "--" not in argv:
        raise SystemExit("Използване: blender --background --python convert_dae_to_ply_blender.py -- input.dae output.ply")
