...
def main() -> None:
    ...
    if args.registry is None:
        ...
        registry_path = root / "rt_out" / "experiments" / "factory_panda_ur5" / "legacy_run_20260522_133045" / "manifests" / "static_registry.json"
    else:
    ...
    if args.out_dir is None:
        out_dir = root / "rt_out" / "experiments" / "factory_panda_ur5" / "legacy_run_20260522_133045" / "static_scene" / "export"
    else:
        out_dir = args.out_dir.expanduser().resolve()

    if args.helper is None:
        helper_path = Path(__file__).resolve().with_name("static_scene_blender_merge_worker.py")
    else:
