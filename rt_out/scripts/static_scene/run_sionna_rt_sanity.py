...
DEFAULT_XML = (
    ...
    / "rt_out"
    / "experiments" / "factory_panda_ur5" / "legacy_run_20260522_133045" / "static_scene"
    / "export"
...
DEFAULT_RT_RUNTIME_CONFIG = None
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Carrier frequency in Hz. Defaults to the legacy run's resolved RT material config "
...
def main() -> int:
    ...
    if args.frequency_hz is None:
        args.frequency_hz = load_rt_runtime_config().carrier_frequency_hz
