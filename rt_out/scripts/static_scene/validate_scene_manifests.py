...
MANIFESTS_DIR = PROJECT_ROOT / "rt_out" / "experiments" / "factory_panda_ur5" / "legacy_run_20260522_133045" / "manifests"
...
ALLOWED_DYNAMIC_MODELS = set(PROTOTYPE_CONFIG.get("model_names", []))
...
def main() -> int:
    global PROTOTYPE_CONFIG, ALLOWED_DYNAMIC_MODELS
    import argparse
    ...
    ALLOWED_DYNAMIC_MODELS = set(PROTOTYPE_CONFIG.get("model_names", []))
    if experiment_root:
        global MANIFESTS_DIR, STATIC_MANIFEST_PATH, DYNAMIC_MANIFEST_PATH, REPORT_PATH, MODELS_ROOT
