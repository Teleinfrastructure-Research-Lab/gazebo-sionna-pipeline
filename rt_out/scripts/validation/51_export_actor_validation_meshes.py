...
validated RT composition path and does not touch scripts 00-36.
"""
...
DEFAULT_VALIDATION_SAMPLES = PROJECT_ROOT / "rt_out" / "actor_validation" / "actor_validation_samples.json"
DEFAULT_OUTPUT_ROOT = PROJECT_ROOT / "rt_out" / "actor_validation"
