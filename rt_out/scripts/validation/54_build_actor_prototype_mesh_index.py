...
DEFAULT_OUTPUT = PROJECT_ROOT / "rt_out" / "actor_prototype_validation" / "actor_prototype_mesh_index.json"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        nargs="+",
        required=True,
        help="Actor frame manifest JSON files from rt_out/dynamic_scene/frame_*/.",
    )
...
def build_mesh_index(manifest_paths: list[Path], output_path: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "purpose": "3-frame actor prototype visual validation mesh index for 52_build_actor_blender_validation_scene.py",
