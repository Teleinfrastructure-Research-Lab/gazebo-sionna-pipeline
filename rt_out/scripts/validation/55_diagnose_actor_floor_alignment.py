...
DEFAULT_MESH_INDEX = PROJECT_ROOT / "rt_out" / "actor_prototype_validation" / "actor_prototype_mesh_index.json"
DEFAULT_STATIC_MANIFEST = PROJECT_ROOT / "rt_out" / "static_scene" / "export" / "merged_static_manifest.json"
DEFAULT_OUTPUT_JSON = PROJECT_ROOT / "rt_out" / "actor_prototype_validation" / "actor_floor_alignment_diagnostics.json"
