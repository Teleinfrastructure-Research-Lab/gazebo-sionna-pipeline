...
DEFAULT_COMPOSED_MANIFEST = (
    PROJECT_ROOT / "rt_out" / "experiments" / "factory_panda_ur5" / "legacy_run_20260522_133045" / "composed_scene" / "frame_000" / "composed_frame_000_manifest.json"
)
DEFAULT_OUTPUT_ROOT = PROJECT_ROOT / "rt_out" / "experiments" / "factory_panda_ur5" / "legacy_run_20260522_133045" / "composed_scene" / "frame_000" / "blender_inspection"
...
def configure_prototype_config(args: argparse.Namespace) -> None:
    ...
    PROTOTYPE_CONFIG = load_dynamic_prototype_config(
        ...
        if args.dynamic_prototype_config else None
    )
    EXPECTED_DYNAMIC_COUNT = PROTOTYPE_CONFIG.get("expected_renderable_visual_count_total", 0)
